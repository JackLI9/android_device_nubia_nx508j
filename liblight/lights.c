...
char const*const BREATH_LED_BUTTON_BACKLIGHT
...
void init_globals(void)
{
    ...
    //turn off breath-led-brightness
    write_int(BREATH_LED, (int)0);
    //turn off button-backlight
    write_int(BREATH_LED_BUTTON_BACKLIGHT, (int)0);
}
	...
	struct light_state_t const* state)
{
    ...
    if (!initialized) {
        ...
        write_int(BREATH_LED_BUTTON_BACKLIGHT, (int)6);
        ...
        struct light_state_t const* state)
{
    ...
    pthread_mutex_lock(&g_lock);
    g_buttons = *state;
    err = write_int(BREATH_LED_BUTTON_BACKLIGHT, brightness?6:2);
...
struct hw_module_t HAL_MODULE_INFO_SYM = {
    ...
    .name = "Nubia Z9 lights Module",
    .author = "Google, Inc., dianlujitao, proDOOMman, JackLI",
